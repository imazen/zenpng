...
def main():
    ...
    pipeline_notes = {
        ...
        3: '5 strat, screen-only',
        4: '9 strat, screen-only',
        ...
        17: '9 strat, screen+refine[20,22]+BF(3,1)',
        18: '9 strat, screen+refine[22,24]',
        19: '9 strat, screen+refine[22,24]+BF(3,1)',
        20: '9 strat, screen+refine[24,26]',
        21: '9 strat, screen+refine[26,28]',
        22: '9 strat, screen+refine[26,28]+BF(5,1)',
