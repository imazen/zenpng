...
fn main() {
    ...
    println!(
        "{:<18} {:>9} {:>9} {:>9} {:>9} {:>9} {:>9} {:>7} {:>7}",
        "image", "zf-L10", "zf-L11", "zf-L12", "ldc-L12", "fl2-best", "zopfli",
        "zf/ldc%", "zf/zop%"
    );
    println!("{}", "-".repeat(105));
    ...
    for (i, path) in paths.iter().enumerate() {
        ...
        println!(
            ...
            short, zf10, zf11, zf12, ldc12, fl2_best_size, zopfli_size,
            zf_vs_ldc, zf_vs_zop,
        );
    ...
    println!(
        "{:<18} {:>9} {:>9} {:>9} {:>9} {:>9} {:>9} {:>+7.3} {:>+7.3}",
        "TOTAL", "", "", total_zf_best, total_ldc12, total_fl2_best, total_zopfli,
        zf_vs_ldc, zf_vs_zop,
    );
    println!("\nzenflate-best vs libdeflate-C: {:+.3}%", zf_vs_ldc);
    println!("zenflate-best vs zopfli:       {:+.3}%", zf_vs_zop);
    println!("zenflate-best vs flate2-best:  {:+.3}%",
...
fn compress_libdeflate_c(data: &[u8], level: i32) -> usize {
    let mut compressor = libdeflater::Compressor::new(libdeflater::CompressionLvl::new(level).unwrap());
